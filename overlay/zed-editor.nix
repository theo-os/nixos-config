...
rustPlatform.buildRustPackage (finalAttrs: {
  pname = "zed-editor";
  version = "99a558f3689e6920eb3c3ad5e78854c7068c5d75";

  src = fetchFromGitHub {
    owner = "zed-industries";
    repo = "zed";
    rev = finalAttrs.version;
    hash = "blake3:110ilqlap168516h3r4q1pqq9maa0rk9irri5nxq5brs2w18bpi0";
  };

  cargoDeps = rustPlatform.fetchCargoVendor {
    inherit (finalAttrs) src;
    hash = "blake3-e12R6Fyi78Snr79GR+cl94PMm5eJ9+SjiZQVZonI444=";
  };
